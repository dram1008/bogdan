...
<section class="container content-section text-center">
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <p>Мы собираем деньги для того чтобы это предотсавить такую возможность для Вас. Только при помощи ваших благодарностей мы сможем вам предоставить такой подарок.</p>
        </div>
    </div>
</section>
