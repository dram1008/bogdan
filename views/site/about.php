...
<section id="about" class="container content-section">
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <p>Основателем компании является человек обладающий колосальными знаниями и опытом полетов в том числе и знание своих прощлых жизней где он ранее летал. В этой жизни он решил сделать людям подарок в виде предоставления технологии полетов. Проект Крылья Ангела и является стартом такой манифестации.</p>
            ...
            <p>Также разрабатывает и продает летающие автомобили (особая секретная технология основнная на принципах антигравитации).</p>
